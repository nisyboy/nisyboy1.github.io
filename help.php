...
<body id="page-help" class="format-site  dir-ltr lang-ru yui-skin-sam yui3-skin-sam www-portal-ratkga-ru pagelayout-popup course-1 context-1 notloggedin content-only">
                ...
                <div id="region-main-wrap">
                    <div id="region-main">
                        <div class="region-content">
                                                        <div role="main"><span id="maincontent"></span><h1 class="helpheading">В Вашем браузере должен быть разрешен прием cookies</h1><div class="no-overflow"><p>На сайте используется два типа cookies:</p>
...
M.yui.galleryversion="2010.04.08-12-35";Y.use("moodle-core-popuphelp",function() {M.core.init_popuphelp();
 ...
 M.util.js_pending('random5cb748554d90f2'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5cb748554d90f2'); });
